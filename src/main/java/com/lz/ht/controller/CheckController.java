...
public class CheckController {
    ...
    @RequestMapping(value = "/check/queryCheckByName",method = {RequestMethod.POST})
    @ResponseBody
    public PageInfo<CostCheck> queryProjectByName(CostCheck costCheck, int currentPageNum, int pageSize)throws Exception{
        //[pageNum, pageSize]  页码  每页显示数量
        PageHelper.startPage(currentPageNum,pageSize);
        PageInfo<CostCheck> pageInfo = new PageInfo<>(costCheckMapper.findByName(costCheck.getCheckName()));
        return pageInfo;
    }
//
//
